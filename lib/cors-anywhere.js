...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  //proxyRes.headers.hasOwnProperty('set-cookie') && (proxyRes.headers['js-set-cookie'] = proxyRes.headers['set-cookie']);
  //proxyRes.headers.hasOwnProperty('set-cookie2') && (proxyRes.headers['js-set-cookie2'] = proxyRes.headers['set-cookie2']);
...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    // js-cookie & js-cookie2
    //req.headers.hasOwnProperty('js-cookie') && (req.headers['cookie'] = req.headers['js-cookie']);
    //req.headers.hasOwnProperty('js-cookie2') && (req.headers['cookie2'] = req.headers['js-cookie2']);
