...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  proxyRes.headers.hasOwnProperty('js-set-cookie') && (proxyRes.headers['js-set-cookie'] = proxyRes.headers['set-cookie']);
  proxyRes.headers.hasOwnProperty('js-set-cookie2') && (proxyRes.headers['js-set-cookie2'] = proxyRes.headers['set-cookie2']);
